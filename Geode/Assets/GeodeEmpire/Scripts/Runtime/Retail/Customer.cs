...
namespace GeodeEmpire.Retail
{
    ...
    public sealed class CustomerArchetype
    {
        ...
        {
            new CustomerArchetype { Name = "Collector", Blurb = "knows exactly what this is", BudgetMin = 1.0f, BudgetMax = 2.2f, BudgetFloor = 70f, Likes = new[] { MineralId.Amethyst, MineralId.Fluorite, MineralId.Celestite }, ColourWeight = 0.5f, SizeWeight = 0.3f, ConditionWeight = 1.0f, Patience = 75f, Threshold = 0.5f,
            ...
            new CustomerArchetype { Name = "Tourist", Blurb = "wants something that sparkles", BudgetMin = 0.35f, BudgetMax = 1.05f, BudgetFloor = 18f, Likes = new[] { MineralId.Agate, MineralId.ClearQuartz, MineralId.Citrine }, ColourWeight = 0.8f, SizeWeight = 0.1f, ConditionWeight = 0.3f, Patience = 40f, Threshold = 0.36f,
            ...
            new CustomerArchetype { Name = "Decorator", Blurb = "buying for a shelf, not a cabinet", BudgetMin = 0.6f, BudgetMax = 1.35f, BudgetFloor = 35f, Likes = new[] { MineralId.Amethyst, MineralId.Citrine, MineralId.Celestite, MineralId.Agate }, ColourWeight = 0.9f, SizeWeight = 0.6f, ConditionWeight = 0.5f, Patience = 55f, Threshold = 0.42f,
            ...
            new CustomerArchetype { Name = "Student", Blurb = "counting coins", BudgetMin = 0.25f, BudgetMax = 0.8f, BudgetFloor = 10f, Likes = new[] { MineralId.Pyrite, MineralId.Calcite, MineralId.Fluorite, MineralId.Aragonite }, ColourWeight = 0.3f, SizeWeight = 0.2f, ConditionWeight = 0.2f, Patience = 60f, Threshold = 0.34f,
            ...
            new CustomerArchetype { Name = "Jeweller", Blurb = "only clean crystal will do", BudgetMin = 0.8f, BudgetMax = 1.8f, BudgetFloor = 45f, Likes = new[] { MineralId.ClearQuartz, MineralId.SmokyQuartz, MineralId.Citrine, MineralId.Amethyst }, ColourWeight = 0.4f, SizeWeight = 0.0f, ConditionWeight = 1.2f, Patience = 50f, Threshold = 0.5f,
            ...
            new CustomerArchetype { Name = "Rockhound", Blurb = "would rather it were bigger", BudgetMin = 0.5f, BudgetMax = 1.25f, BudgetFloor = 28f, Likes = new[] { MineralId.SmokyQuartz, MineralId.Pyrite, MineralId.Aragonite, MineralId.Celestite }, ColourWeight = 0.2f, SizeWeight = 0.7f, ConditionWeight = 0.6f, Patience = 90f, Threshold = 0.4f,
