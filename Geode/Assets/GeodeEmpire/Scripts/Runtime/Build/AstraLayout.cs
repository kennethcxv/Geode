...
namespace GeodeEmpire.Build
{
    ...
    public static class AstraLayout
    {
        ...
        public static readonly Space[] Spaces =
        {
            ...
            S("wash_station", "Processing", -5.95f, 3.00f, 0.80f, 1.15f, 0.92f, 270f, -4.95f, 3.00f, 1.0f, 1.15f),
            ...
            S("bay_1", "Processing", -4.15f, 4.47f, 1.20f, 0.80f, 0.45f),
            S("bay_2", "Processing", -2.80f, 4.47f, 1.20f, 0.80f, 0.45f),
            S("bay_3", "Processing", -4.15f, 5.47f, 1.20f, 0.80f, 0.45f),
            S("bay_4", "Processing", -2.80f, 5.47f, 1.20f, 0.80f, 0.45f),
