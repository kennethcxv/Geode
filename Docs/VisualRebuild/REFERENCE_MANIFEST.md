...
| R10 | 04_11_02 PM | Polishing station | branded lap on a blue plinth | plainer machine, no plinth | machine livery plinth + mat | ✔ | ✔ | M2 |
| R11 | 04_11_10 PM | **Build mode** | full-screen layout editor: shop-overview panel, budget, category tabs, item hotbar with prices, green ghost + footprint grid, right-hand item card, rotate/place/cancel/duplicate rail | **no counterpart** | **build the mode** — the centre of this phase | – | ✔ | M4 |
| R12 | 04_11_16 PM | Special orders board | pinned commission cards | tablet only | commissions board in the office | ✔ | ✔ | M6 |
| R13 | 04_11_24 PM | Packing station | bench with boxes, tape, labels | no counterpart | packing bench in storage (dressing; fulfilment stays V6) | ✔ | ✔ | M6 |
...
| R23 | 04_13_12 PM | Cracker close-up | A-frame hydraulic press, chrome ram, blue pump body, brass pipework, green lever handles, **yellow maker's plate** | current cracker is a bench device | rebuild the machine; adopt the yellow plate as the machine-sign language | ✔ | – | M2 |
| R24 | 04_13_19 PM | Wash station | stainless sink run | – | keep; set it into a cabinet run | ✔ | ✔ | M2 |
| R25 | 04_13_25 PM | Inspection bench | rough rocks lined up under a task lamp | benches are bare | line the bench with rough rock | – | ✔ | M2 |
| R26 | 04_13_30 PM | **Workshop overview** | machines as islands on blue base cabinets with grey tops, anti-fatigue mats, hanging plaque signs over each station, dark plank walls, polished concrete, black cone pendants on rods, rough rock lined along the inspection bench, showroom visible beyond, key rail with **B Build Mode** and **I Inventory** | everything against the walls, dead centre floor, one orange hue, flat floor, decal signs crowded on one wall, bare benches | the whole of M1–M3 | ✔ | ✔ | M1–M3 |
