...
QA25 FINISHED2026-09-06T23:47:05.437102Z; custom3customersallserved/0empty/0recovery/pathfailure/jam/0pairspacing<.52m,67.20s. Continue withoutFlush entireSavedStateexact/island90/sixSold/cash140.7. WallC/customisland0penetrations>1mm. ARCHITECTURE_CUSTOM_CONTINUE.json.


QA25 verified fresh120/minimumkit0earnedbodies and4starterpathsComplete; mature15bodies/carvers,15validdefaultplacements/60groundplaneroutesComplete. ProposedWallC180 refused whilelive0; TryPlace180 refused andsavedposeunchanged; inactiveBody180refused/0valid. Initial3DSample(.35) falsealarmon4Stage2attachmentbrowsepointsy.75: exactNavMesh.CalculatePath toactual3Dpositions allComplete. NativeWallC0 saved; sourcecompiledclean. Mature3staggeredcustomers all3served,0empty,77.66s,no pathfailure/stuck/reposition/jam orpairdistance<.52m. RawobserveremptyIdsincorrectlyincludespaidbecauseWantedclears; all3Thanking+3sales proves0empty, correctedcustomobserver uses!Bought. StockS0001-0002 remainsSale40; S0002-0004Sale41/S0003-0002Sale36/S0004-0004Sale37 allSold. Cash120→128.849991.

Custom90degreeislandrotationaccepted; wallCshiftblockedothercasebrowseandcombinedislandmove/rotationcorrectlyrefused.15placement/60routesstillpass,2newsyntheticislandstock plusremainingWallC. Performance3swarmup+10s noMCP/1408frames,978x519Editor; framep50/95/99/max6.57/12.99/16.53/29.43ms,CPU6.57/12.96/16.76/29.94ms. GPUzerosmakeitsdistributionincomplete. GCbytesp509076,p959624,p9922599,max1034986 includesEditor/observer. Allocated581.08MB. Camera mayentercheckoutduringharness, nativefixed-cameralabeltoo specific. Notstandalone/FHD/fullstock/Steamperformanceacceptance. ARCHITECTURE_STANDING_CUSTOMER_REGRESSION.json saved completed evidence.


QA24 already passed: fresh120/0earned bodies/0fixture carvers; closed physical starter entrance outside→door/counter Complete. Unleased showroom remains Partial behind four active closure carvers. Diagnostic cash3000 + normal BackRoom/Wash purchases→2310. Wash first placement(-5.75,0,3)90 autosaved. Second successful normal move(-1.5,0,3)270 autosaved after2s WITHOUT Flush, live==disk; old footprint becomes walkable/new footprint blocked WITHOUT rebake; Continue preserves exact pose and active obstacle. Starter synthetic2/4 stock through normal pickup/zone placement; two actual customers walked/browsed/queued/left, established checkout harness served1, empty1, cash2310→2314.95. Normal ShopFront purchase→1114.95, included case placed(2,0,4.5)270. Old starter sale specimen automatically retained in REC-A1-S0002-0004 with original lot identity and no appraisal; opened/recovered through normal crate/pickup, placed in case, empty parcel cleared. Expanded door/counter routes Complete without rebake. Two expanded customers naturally browsed/queued and harness served both; cash→1121.84985. Zero path failures/stuck recoveries/repositions/jam reports. Artificial simultaneous diagnostic spawns do not prove overlap stress acceptance. No runtime errors through 23:17:45 UTC. Full manual career and retail input acceptance remain later gates.

Navigation authoring HAS RUN ONCE and saved: door-leaf ignore modifiers, .05m surface voxel,15 assigned fixture carving proxies,2 counter and4 closure proxies,23 total modifiers. Keep physical colliders. PlaceableFixture.RefreshNavigation follows body/ownership/saved pose; FixtureWorld invokes it. BuildMode.TryPlace queues every successful placement independent of completed tutorial. Compile clean. Candidate has91zones and unchanged Delivery IDs1990628459/616842567/166829470. Never rerun ConfigureAstraCandidateNavigation.

QA23 `237a3e02af324739b0cfe8486e6e7d41` FINISHED 2026-09-06T22:56:16.128638Z; guard TRUE and original career/settings/backup hashes unchanged. Temporary Play navigation controls reverted; later native authoring above is intentional. No safety incident.
...
Allcandidate one-shots ALREADYRUN andsaved: CreateAstraWorkshopCandidate, FinishAstraCandidatePrimaryLayout, ConfigureAstraCandidateMinimumKit, AttachAstraCandidateOpenSigns, ConfigureAstraCandidateLateFixtures, ConfigureAstraCandidateMachineBodies, ConfigureAstraCandidatePracticalLighting, ConfigureAstraCandidateNavigation. Never rerun. Separate save_scene afterbuilder Undoresolveddeferreddirty. Candidate NOTinbuildsettings, Workshopunchanged.
